    ...
    <div className="md:w-[500px] w-auto m-auto p-4">
      <div className="drop-shadow-xl p-2 shadow-blue-500/50  bg-blue-200 rounded-md ">
        <form onSubmit={handleSubmit(loginUserData)} className="flex flex-col gap-4 items-center">
          ...
          <input className="cursor-pointer p-2 rounded-md text-white px-4 bg-green-500 hover:bg-green-400 hover:shadow-lg" type="submit" value="Login" />
        </form>
      ...
      <Link href={'/register'} className="text-center underline my-4 mx-auto">New User? register here</Link>
    </div>
  )
}
